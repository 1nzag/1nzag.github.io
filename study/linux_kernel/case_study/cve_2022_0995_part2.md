...
[내가 참조한 문서](https://google.github.io/security-research/pocs/linux/cve-2021-22555/writeup.html)에서는 다음과 같은 설명을 하고 있다. 
...
뭔가 사기적인 설명이다. `sk_buff`를 이용해 free 된 청크에 다시 접근을 할 수 있다니! 일단 믿고 해당 기술을 써보기로 했다. 

그럼 일단 free 된 청크를 다시 쓰기 전에, 거기에 새로운 값을 써서 읽어 커널 베이스를 알아내야 한다. 
